#' @title Holiday Data
#'
#' @description Builds a dataframe of holiday dates between 2 dates in the
...
holiday_data <- function(df, out_df = c('weeks','days')) {
  ...
  US_Tgt_Cirle_Wk_Summer <- USTgt_Cirle_Wk_Summer(years)%>% as.Date()
  Name_Tgt_Cirle_Wk_Summer <- Holiday_Names("TargetCircleWeek_Summer",US_Tgt_Cirle_Wk_Summer)

  US_Tgt_Cirle_Wk_Fall <- USTgt_Cirle_Wk_Fall(years)%>% as.Date()
  Name_Tgt_Cirle_Wk_Fall <- Holiday_Names("TargetCircleWeek_Fall",US_Tgt_Cirle_Wk_Fall)
  # Retail Holidays -----------------------------------------------------------
